        ...
        static void Main(string[] args)
        {
            var host = Host.CreateDefaultBuilder(args)
                .ConfigureServices(services => {
                    ...
                    {
                        options.UseSqlServer(@"data source=DESKTOP-QDKASVN\\SQLEXPRESS;initial catalog=CardStorageService;User Id=CardStorageServiceAdmin;Password=admin12345;MultipleActiveResultSets=True;App=EntityFramework");                        
                    });
